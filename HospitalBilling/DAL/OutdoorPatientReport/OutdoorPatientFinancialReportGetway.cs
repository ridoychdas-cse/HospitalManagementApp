...
namespace HospitalBilling.DAL.OutdoorPatientReport
{
    public class OutdoorPatientFinancialReportGetway
    {
        public DataTable GetData(string startDate, string endDate, string BillNo, string PatientId, string DiagnosisTypeId, string DiagnosisId, string ReportType)
        {
            ...
            {
                SqlCommand sqlComm = new SqlCommand("Sp_OutdoorPatientFinancialReport", conn);
                ...
                da.Fill(ds, "Sp_OutdoorPatientFinancialReport");
                DataTable data = ds.Tables["Sp_OutdoorPatientFinancialReport"];
                return data;
            }
        }
    }
