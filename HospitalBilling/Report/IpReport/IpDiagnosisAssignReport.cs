...
namespace HospitalBilling.Report.IpReport
{
    public class IpDiagnosisAssignReport
    {
        ...
        public void GetReport1(Document document, PdfWriter writer, OpDiagnosisAssignReportModel assignReportModel)
        {
            var organization = _organizationManager.GetOrganizations();
            // Report
        ...
        public void GetSurgeryReport(Document document, PdfWriter writer, OpDiagnosisAssignReportModel assignReportModel)
        {
            var organization = _organizationManager.GetOrganizations();
            ...
            cell = new PdfPCell(ITextSharpFont.H6Bold("Surgery Name"));
            cell.HorizontalAlignment = 1;
            cell.VerticalAlignment = 1;
            cell.FixedHeight = 20f;
            dth3.AddCell(cell);
            ...
            int serial = 0;
            foreach (var billDtl in assignReportModel.SurgeryBillDtls)
            {
                serial++;
                ...
                cell = new PdfPCell(ITextSharpFont.H6Normal(billDtl.SurgeryName));
                cell.HorizontalAlignment = 0;
                cell.VerticalAlignment = 0;
                cell.FixedHeight = 20f;
                //cell.BorderColor = BaseColor.LIGHT_GRAY;
            ...
            cell = new PdfPCell(ITextSharpFont.H6Normal("Total Surgery Fee: "));
            cell.HorizontalAlignment = 2;
            cell.VerticalAlignment = 2;
            cell.BorderWidth = 0f;
        ...
        public void GetSurgeryReport1(Document document, PdfWriter writer, OpDiagnosisAssignReportModel assignReportModel)
        {
            var organization = _organizationManager.GetOrganizations();
            // Report
            ...
            var c = new PdfPCell(ITextSharpFont.H7Normal("System Create By Netsoft Solution Ltd. Contact Us: https://netsoftbd.com/"))
            {
                Border = Rectangle.NO_BORDER,
                VerticalAlignment = Element.ALIGN_BOTTOM,
                HorizontalAlignment = Element.ALIGN_LEFT,
