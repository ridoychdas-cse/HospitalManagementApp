<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OpDiagnosisAssignForm.aspx.cs" Inherits="HospitalBilling.UI.OpDiagnosisAssignForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        ...
                                        <ajaxToolkit:AutoCompleteExtender ID="patientIdTextBox_AutoCompleteExtender"
                                                    ...
                                                    ServiceMethod="GetOutdoorPatient" ServicePath="~/AutoComplete.asmx"
                                    ...
                                    <div class="col-md-1">
                                        <asp:LinkButton ID="newPatientLinkButton" CssClass="btn btn-primary btn-sm" runat="server">New Patient<%--<i class="fa fa-search" aria-hidden="true"></i>--%></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                   ...
                                   <%-- <ajaxToolkit:AutoCompleteExtender ID="diagnosisAutoCompleteExtender" ServiceMethod="GetDiagnosisByType" TargetControlID="patientIdTextBox" runat="server"></ajaxToolkit:AutoCompleteExtender>--%>
                                </div>
                            ...
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="consultantFeeTextBox" CssClass="form-control input-sm" runat="server" Height="30px">0</asp:TextBox>
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <%--<div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>Bill No:</label>
                                    <asp:TextBox ID="billNoTextBox" CssClass="form-control input-sm" runat="server" Height="30px" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>--%>
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="outdoorPatientPopup" TargetControlID="newPatientLinkButton" BackgroundCssClass="modalBackground"
    ...
    <asp:Panel runat="server" ID="outdoorPatientPanel" Width="60%" Style="display: none" >
                            ...
                            <div class="col-md-12">
                                <div role="form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <asp:Button ID="newPatientSaveButton" runat="server" CssClass="btn btn-primary" Text="Save" OnClick="newPatientSaveButton_Click" />
                                            <asp:LinkButton ID="closeLinkButton" runat="server"  CssClass="btn btn-primary" OnClick="closeLinkButton_Click" ><i class="fa fa-window-close-o" aria-hidden="true"></i> Close</asp:LinkButton><%--OnClientClick="HideModalDiv();"--%>
                                        </div>
                                    </div>
