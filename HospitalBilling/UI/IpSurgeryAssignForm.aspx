<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IpSurgeryAssignForm.aspx.cs" Inherits="HospitalBilling.UI.IpSurgeryAssignForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <asp:HiddenField ID="idHiddenField" runat="server" />
    <div class="row">
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i></a></li>
            <li class="active">Indoor Patient Surgery Bill Assign Form</li>
        </ol>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">Surgery Info</div>
                <div class="panel-body">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Surgery Type <strong style="color: red; font-size: 15px">*</strong></label>
                                    <asp:DropDownList ID="surgeryTypeDropDownList" CssClass="form-control input-sm" runat="server" Height="30px" AutoPostBack="True" OnSelectedIndexChanged="surgeryTypeDropDownList_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>

                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Surgery<strong style="color: red; font-size: 15px">*</strong></label>
                                    <asp:DropDownList ID="surgeryDropDownList" CssClass="form-control input-sm" runat="server" Height="30px" AutoPostBack="True" OnSelectedIndexChanged="surgeryDropDownList_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>

                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Surgery Date <strong style="color: red; font-size: 15px">*</strong></label>
                                    <asp:TextBox ID="surgeryDateTextBox" CssClass="form-control input-sm" runat="server" Height="30px"></asp:TextBox>
                                    <ajaxToolkit:CalendarExtender ID="surgeryDateCalendarExtender" TargetControlID="surgeryDateTextBox" Format="dd-MM-yyyy" runat="server" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Price</label>
                                    <asp:TextBox ID="priceTextBox" CssClass="form-control input-sm" runat="server" Height="30px" AutoPostBack="True" OnTextChanged="discountByTestTextBox_TextChanged">0</asp:TextBox>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Assign Surgery List</div>
                        <div class="panel-body">
                            <asp:UpdatePanel ID="surgeryBillListUpdatePanel" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="surgeryBillGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                        <Columns>
                                            <asp:TemplateField Visible="False">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="surgeryTypeIdLabel" Text='<%#Eval("SurgeryTypeId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Surgery Type">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%#Eval("SurgeryTypeName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField Visible="False">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="surgeryIdLabel" Text='<%#Eval("SurgeryId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Surgery">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%#Eval("SurgeryName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
