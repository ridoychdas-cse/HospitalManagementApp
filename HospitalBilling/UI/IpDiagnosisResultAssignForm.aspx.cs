...
namespace HospitalBilling.UI
{
     ...
     public partial class IpDiagnosisResultAssignForm : System.Web.UI.Page
    {
         public OutdoorPatientManager _outdoorPatientManager = new OutdoorPatientManager();
         public IndoorPatientManager _indoorPatientManager = new IndoorPatientManager();
        ...
        protected void searchLinkButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var patient = _indoorPatientManager.GetPatientByBillNo(searchInput);
                if (patient == null)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "ale",
        ...
        {
            Response.Redirect("IpDiagnosisResultAssignForm.aspx");
        }
        ...
        private void Report()
        {
            ...
            const string patientType = "Indoor Patient";
