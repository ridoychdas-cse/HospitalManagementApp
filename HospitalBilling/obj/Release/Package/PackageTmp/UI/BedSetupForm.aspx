<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BedSetupForm.aspx.cs" Inherits="HospitalBilling.UI.BedSetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="panel panel-default">
                <div class="panel panel-warning">
                    <div class="form-inline">
                        ...
                        <asp:TextBox ID="searchTextBox" CssClass="form-control" runat="server" placeholder="Search By Name / Number"></asp:TextBox>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel panel-warning">
                    <asp:GridView ID="bedGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name / Number">
                            ...
                            <asp:TemplateField Visible="False">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%#Eval("WardId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Ward Name">
                                <ItemStyle HorizontalAlign="Center" Width="25%"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%#Eval("WardName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Price Daily">
                                <ItemStyle HorizontalAlign="Center" Width="20%"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%#Eval("PriceDaily") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="bedPopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="bedPanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="bedPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="bedUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Bed Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name / Number <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Bed Name / Number" Text="B-"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Ward Name <strong style="color: red; font-size: 18px">*</strong></label>
                                        <asp:DropDownList ID="wardDropDownList"  class="form-control" runat="server"></asp:DropDownList>
                                        <%--<asp:TextBox ID="shortNameTextBox" runat="server" class="form-control" placeholder="Short Name"></asp:TextBox>--%>
                                    </div>

                                    <div class="form-group">
                                        <label>Price Daily <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="priceDailyTextBox" runat="server" class="form-control">0</asp:TextBox>
                                    </div>
                                </div>
                                <div>
    ...
    <asp:Panel runat="server" ID="editPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="editUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Edit Bed</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                   <div role="form">
                                    <div class="form-group">
                                        <label>Name / Number <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="editNameTextBox" runat="server" class="form-control" placeholder="Bed Name / Number" Text="B-"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Ward Name <strong style="color: red; font-size: 18px">*</strong></label>
                                        <asp:DropDownList ID="editWardDropDownList"  class="form-control" runat="server"></asp:DropDownList>
                                        <%--<asp:TextBox ID="shortNameTextBox" runat="server" class="form-control" placeholder="Short Name"></asp:TextBox>--%>
                                    </div>

                                    <div class="form-group">
                                        <label>Price Daily <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="editPriceDailyTextBox" runat="server" class="form-control">0</asp:TextBox>
                                    </div>
                                </div>
