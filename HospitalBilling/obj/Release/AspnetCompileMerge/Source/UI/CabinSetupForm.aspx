<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CabinSetupForm.aspx.cs" Inherits="HospitalBilling.UI.CabinSetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Cabin Setup</li>
        </ol>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6">
                            <div class="input-group" style="border: 1px solid black; border-radius: 5px;">
                                <asp:TextBox ID="searchTextBox" CssClass="form-control borderRignt" runat="server" placeholder="Search By Name or Number"></asp:TextBox>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Cabin List</div>
                <div class="panel-body">
                    <asp:GridView ID="cabinGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Cabin Name">
                                <ItemStyle HorizontalAlign="Center" Width="20%"></ItemStyle>
                                <ItemTemplate>
    ...
    <asp:Panel runat="server" ID="bedPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="bedUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Cabin Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name / Number <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Cabin Name / Number" Text="C-"></asp:TextBox>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                   <div role="form">
                                    <div class="form-group">
                                        <label>Name / Number <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="editNameTextBox" runat="server" class="form-control" placeholder="Cabin Name" Text="C-"></asp:TextBox>
                                    </div>
