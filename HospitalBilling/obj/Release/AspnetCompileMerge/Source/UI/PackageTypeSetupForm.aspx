<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PackageTypeSetupForm.aspx.cs" Inherits="HospitalBilling.UI.PackageTypeSetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Package Type Setup</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <asp:GridView ID="packageTypeGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="surgeryTypePopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="packageTypePanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="packageTypePanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="surgeryTypeUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Package Type Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name</label>
                                        *
                                            <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Package Type Name"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="descriptionTextBox" runat="server" class="form-control" placeholder="Package Type Details" Height="90px" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div>
    ...
    <asp:Panel runat="server" ID="editPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="editUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Edit Package Type</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name</label>
                                        *
                                            <asp:TextBox ID="editNameTextBox" runat="server" class="form-control" placeholder="Package Type Name"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Description</label>
                                        <asp:TextBox ID="editdescriptionTextBox" runat="server" class="form-control" placeholder="Pacakage Details" Height="90px" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div>
    ...
    <asp:Panel runat="server" ID="deletePanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="deleteUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Delete Package Type</div>
                        <div class="panel-body">
                            <div class="col-md-12">

                                <div>
                                    <label>Are you sure to Delete This Package Type</label><br />
                                    <table class="nav-justified">
                                        <tr>
