<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SurgerySetupForm.aspx.cs" Inherits="HospitalBilling.UI.SurgerySetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Surgery Setup</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <asp:GridView ID="surgeryGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("SurgeryTypeId") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="surgeryPopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="surgeryPanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="surgeryPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="surgeryUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Surgery Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name</label>
                                        *
                                            <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Surgery Name"></asp:TextBox>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Short Name</label>
                                            <asp:TextBox ID="shortNameTextBox" runat="server" class="form-control" placeholder="Surgery Short Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Surgery Type</label>
                                        <asp:DropDownList ID="surgeryTypeDropDownList"  class="form-control" runat="server"></asp:DropDownList>
                                    </div>
    ...
    <asp:Panel runat="server" ID="editPanel" Style="display: none"  Width="40%">
        <asp:UpdatePanel ID="editUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Edit Surgery</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name</label>
                                        *
                                            <asp:TextBox ID="editNameTextBox" runat="server" class="form-control" placeholder="Surgery Name"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Short Name</label>
                                        *
                                            <asp:TextBox ID="editShortNameTextBox" runat="server" class="form-control" placeholder="Surgery Short Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Surgery Type</label>
                                        <asp:DropDownList ID="editSurgeryTypeDropDownList" class="form-control" runat="server"></asp:DropDownList>
    ...
    <asp:Panel runat="server" ID="deletePanel" Style="display: none"  Width="40%">
        <asp:UpdatePanel ID="deleteUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Delete Surgery</div>
                        <div class="panel-body">
                            <div class="col-md-12">

                                <div>
                                    <label>Are you sure to Delete This Surgery</label><br />
                                    <table class="nav-justified">
                                        <tr>
