<%@ Page Title="Doctor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DoctorSetupForm.aspx.cs" Inherits="HospitalBilling.UI.DoctorSetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Doctor Setup</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <asp:GridView ID="doctorGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Specialty">
                        <ItemStyle HorizontalAlign="Center" Width="15%"></ItemStyle>
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("Specialty") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="Profile Brif">
                        <ItemStyle HorizontalAlign="Left" Width="20%"></ItemStyle>
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("ProfileBrief") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="doctorPopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="doctorPanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="doctorPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="doctorUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Doctor Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Doctor Name"></asp:TextBox>
                                    </div>
                                    ...
                                    <%--<div class="form-group">
                                        ...
                                        <asp:DropDownList ID="designationDropDownList"  class="form-control" runat="server"></asp:DropDownList>
                                    </div>--%>

                                    <div class="form-group">
                                        <label>Speciality</label>
                                            <asp:TextBox ID="specialityTextBox" runat="server" class="form-control" placeholder="Doctor speciality"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Designation</label>
                                        <asp:TextBox ID="designationTextBox" runat="server" class="form-control" placeholder="Doctor Designation"></asp:TextBox>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Profile Brief</label>
                                            <asp:TextBox ID="profileBriefTextBox" runat="server" class="form-control" placeholder="Profile Brief" Height="90px" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                   <div role="form">
                                    <div class="form-group">
                                        <label>Name <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="editNameTextBox" runat="server" class="form-control" placeholder="Doctor Name"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Department</label>
                                        <asp:DropDownList ID="editDepartmentDropDownList"  class="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                    
                                    <%--<div class="form-group">
                                        <label>Designation</label>
                                        <asp:DropDownList ID="editDesignationDropDownList"  class="form-control" runat="server"></asp:DropDownList>
                                    </div>--%>

                                    <div class="form-group">
                                        <label>Speciality</label>
                                            <asp:TextBox ID="editSpecialityTextBox" runat="server" class="form-control" placeholder="Doctor speciality"></asp:TextBox>
                                    </div>


                                       <div class="form-group">
                                           <label>Designation</label>
                                           <asp:TextBox ID="editDesignationTextBox" runat="server" class="form-control" placeholder="Doctor Designation"></asp:TextBox>
                                       </div>
                                    
                                    <div class="form-group">
                                        <label>Profile Brief</label>
                                            <asp:TextBox ID="editProfileBriefTextBox" runat="server" class="form-control" placeholder="Profile Brief" Height="90px" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div>
    ...
    <asp:Panel runat="server" ID="deletePanel"  Style="display: none" Width="40%">
        <asp:UpdatePanel ID="deleteUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Delete Doctor</div>
                        <div class="panel-body">
                            <div class="col-md-12">

                                <div>
                                    <label>Are you sure to Delete This Doctor</label><br />
                                    <table class="nav-justified">
                                        <tr>
