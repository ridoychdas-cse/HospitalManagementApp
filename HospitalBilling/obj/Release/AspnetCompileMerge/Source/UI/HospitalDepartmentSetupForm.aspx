<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HospitalDepartmentSetupForm.aspx.cs" Inherits="HospitalBilling.UI.HospitalDepartmentSetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Hospital Department Setup</li>
        </ol>
    </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView ID="hospitalDepartmentGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="departmentPopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="departmentPanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="departmentPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="departmentUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Hospital Department Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>Name <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Department Name"></asp:TextBox>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Short Name <strong style="color: red; font-size: 18px">*</strong></label>
    ...
    <asp:Panel runat="server" ID="editPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="editUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Edit Department Type</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Short Name <strong style="color: red; font-size: 18px">*</strong></label>
                                            <asp:TextBox ID="editShortTextBox" runat="server" class="form-control" placeholder="Short Name"></asp:TextBox>
                                    </div>
