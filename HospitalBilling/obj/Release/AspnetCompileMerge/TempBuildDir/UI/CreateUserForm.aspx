<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateUserForm.aspx.cs" Inherits="HospitalBilling.UI.CreateUserForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <asp:GridView ID="userGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="User Role">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("UserRoleName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="userPopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="userPanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="userPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="bedUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">User Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        ...
                                        *
                                            <asp:TextBox ID="firstNameTextBox" runat="server" class="form-control" placeholder="First Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <asp:TextBox ID="lastNameTextBox" runat="server" class="form-control" placeholder="Last Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Phone No</label>
                                        *
                                            <asp:TextBox ID="phoneNoTextBox" runat="server" class="form-control" placeholder="Phone No"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>User Name</label>
                                        *
                                            <asp:TextBox ID="userNameTextBox" runat="server" class="form-control" placeholder="User Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Password</label>
                                        *
                                            <asp:TextBox ID="passwordTextBox" runat="server" class="form-control" placeholder="Password"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Confirm Password</label>
                                        *
                                            <asp:TextBox ID="confirmPasswordTextBox" runat="server" class="form-control" placeholder="Confirm Password"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>User Role</label>
                                        *
                                        <asp:DropDownList ID="userRoleDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="saveLinkButton" runat="server" CssClass="btn btn-primary" Width="70%" OnClick="saveLinkButton_Click"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</asp:LinkButton></td>
                                            <td>
                                                <asp:LinkButton ID="clearLinkButton" runat="server" CssClass="btn btn-primary" Width="70%" OnClick="clearLinkButton_Click"><i class="fa fa-refresh" aria-hidden="true"></i> Clear</asp:LinkButton></td>
                            ...
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="form-group">
                                        <label>First Name</label>
                                        *
                                            <asp:TextBox ID="editFirstNameTextBox" runat="server" class="form-control" placeholder="First Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <asp:TextBox ID="editLastNameTextBox" runat="server" class="form-control" placeholder="Last Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Phone No</label>
                                        *
                                            <asp:TextBox ID="editPhoneNoTextBox" runat="server" class="form-control" placeholder="Phone No"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>User Name</label>
                                        *
                                            <asp:TextBox ID="editUserNameTextBox" runat="server" class="form-control" placeholder="User Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Password</label>
                                        *
                                            <asp:TextBox ID="editPasswordTextBox" runat="server" class="form-control" placeholder="Password"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>Confirm Password</label>
                                        *
                                            <asp:TextBox ID="editConfirmPasswordTextBox" runat="server" class="form-control" placeholder="Confirm Password"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label>User Role</label>
                                        *
                                        <asp:DropDownList ID="editUserRoleDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                    </div>
   ...
   <%-- ************************************** Start Ddelete Panel Style="display: none"************************************************ --%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#administrationDropdown").addClasses('in');
        });
    </script>
</asp:Content>
