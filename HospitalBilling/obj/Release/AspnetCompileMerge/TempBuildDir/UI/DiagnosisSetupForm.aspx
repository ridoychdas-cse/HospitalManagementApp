<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DiagnosisSetupForm.aspx.cs" Inherits="HospitalBilling.UI.DiagnosisSetupForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Daignosis Setup</li>
        </ol>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="form-inline">
                        ...
                        <asp:TextBox ID="searchTextBox" CssClass="form-control" runat="server" placeholder="Search by Name Or Type"></asp:TextBox>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Daignosis List</div>
                <div class="panel-body">
                    <asp:GridView ID="diagnosisGridView" runat="server" AutoGenerateColumns="False" CssClass="table" CellPadding="4" ForeColor="#333333">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="False">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%#Eval("DiagnosisTypeId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Daignosis Name">
                                <ItemStyle HorizontalAlign="Center" Width="15%"></ItemStyle>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Description">
                                ...
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%#Eval("Discription") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <ajaxToolkit:ModalPopupExtender runat="server" ID="diagnosisPopup" TargetControlID="createNewLinkButton" BackgroundCssClass="modalBackground"
        PopupControlID="diagnosisPanel" CancelControlID="closeLinkButton" />
    ...
    <asp:Panel runat="server" ID="diagnosisPanel" Style="display: none" Width="40%">
        <asp:UpdatePanel ID="dignososUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Diagnosis Setup</div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div role="form">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="nameTextBox" runat="server" class="form-control" placeholder="Diagnosis Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="diagnosisTypeDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="descriptionTextBox" runat="server" class="form-control" placeholder="Diagnosis Details" Height="90px" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="normalValueTextBox" runat="server" class="form-control" placeholder="Reference Value"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>UOM</label>
                                                <asp:DropDownList ID="UOMDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Regular Fee <strong style="color: red; font-size: 18px">*</strong></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Discount <strong style="color: red; font-size: 18px"> </strong> </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Total Fee <strong style="color: red; font-size: 18px">*</strong></label>
                                                <asp:TextBox ID="totalFeeTextBox" runat="server" class="form-control" ReadOnly="True"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="row">
                                       ...
                                       <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Name <strong style="color: red; font-size: 18px">*</strong></label>
                                                <asp:TextBox ID="editNameTextBox" runat="server" class="form-control" placeholder="Diagnosis Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="form-group">
                                                  <label>Diagnosis Type <strong style="color: red; font-size: 18px">*</strong></label>
                                                  <asp:DropDownList ID="editDiagnosisTypeDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                                  <%--<asp:TextBox ID="shortNameTextBox" runat="server" class="form-control" placeholder="Short Name"></asp:TextBox>--%>
                                              </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label>Reference Value</label>
                                                  <asp:TextBox ID="editnormalValueTextBox" runat="server" class="form-control" placeholder="Reference Value"></asp:TextBox>
                                              </div>
                                          </div>
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label>UOM</label>
                                                  <asp:DropDownList ID="editUOMDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                              </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label>Regular Fee <strong style="color: red; font-size: 18px">*</strong></label>
                                                  <asp:TextBox ID="editRegularFeeTextBox" runat="server" class="form-control" placeholder="Regular Fee" AutoPostBack="True" OnTextChanged="regularFeeTextBox_TextChanged">0</asp:TextBox>
                                              </div>
                                          </div>
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label>Discount <strong style="color: red; font-size: 18px"></strong></label>
                                                  <asp:TextBox ID="editDiscountTextBox" runat="server" class="form-control" placeholder="Discount" AutoPostBack="True" OnTextChanged="discountTextBox_TextChanged">0</asp:TextBox>
                                              </div>
                                          </div>
