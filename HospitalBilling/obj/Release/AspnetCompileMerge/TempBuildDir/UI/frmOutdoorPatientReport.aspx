<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmOutdoorPatientReport.aspx.cs" Inherits="HospitalBilling.UI.frmOutdoorPatientReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"> Outdoor Patient Report</li>
        </ol>
    </div>
            ...
            <div class="col-md-12 col-lg-12">
             ...
             <div class="col-md-12 col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            <rsweb:ReportViewer ID="OutdoorPatientReportViewer" Width="100%" runat="server"></rsweb:ReportViewer>
                        </div>
                        </div>
                    </div>
                 </div>
