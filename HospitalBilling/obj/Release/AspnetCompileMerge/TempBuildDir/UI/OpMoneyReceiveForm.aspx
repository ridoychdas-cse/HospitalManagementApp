<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OpMoneyReceiveForm.aspx.cs" Inherits="HospitalBilling.UI.OpMoneyReceiveForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Outdoor Patient Money Receive Form</li>
        </ol>
    </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:Button ID="reloadButton" CssClass="btn btn-primary" runat="server" Text="Reset" OnClick="reloadButton_Click"/>
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-6 col-sm-6  control-label" runat="server" id="discountLabel"> Discount:</label>
                                            <div class="col-md-6 col-sm-6 float-right">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-4 col-sm-offset-2 col-md-8  col-sm-10">
                                                <asp:Button ID="billReportButton" runat="server" CssClass="btn btn-primary " Text="History Report" OnClick="billReportButton_Click" />
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <%--<div class="row">--%>
                                <div class="panel-heading">Diagnosis Bill List</div>
                                <asp:GridView ID="billListGridView" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanged="billListGridView_SelectedIndexChanged">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Special Discount">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%#Eval("SpecialDiscount") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Total Pay Amount">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Total Due Amount">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%#Eval("TotalDueAmount") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            
                                            <asp:TemplateField HeaderText="Entry Date">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%#Eval("EntryDate", "{0:dd-MM-yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
